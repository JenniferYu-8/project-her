...
def get_impact():
    ...
    IMPACT = f"In 65 words, what impact does {latest_answer.name}, a {latest_answer.gender} interested in {latest_answer.interest}, currently a {latest_answer.position} with aspirations to be a {latest_answer.future}, have on their community in the future? Have a positive tone."
